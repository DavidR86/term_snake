### *** Same as the other file, snake.s but uses ASCII characters instead of unicode emojis for terminals that don't support the latter.
	.include "read_kbd.s"
	.include "score.s"
	.include "screen.s"
	.include "rand.s"
...
check_defeat_end:	
	...
	movq $64, %rdi
	call print_char_at_coord # ASCII version
